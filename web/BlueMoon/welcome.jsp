...
ResultSet rs=st.executeQuery("select * from rooms_bluemoon"); 
int count = 0;
while (rs.next()) {
    ++count;
}
...
<div class="jumbotron" style="width:80%; background-color: #950740; color: white; ">
    <h4> Rooms Available : </h4><br>
     <div class="col-container">
          ...
          <% 
         rs=st.executeQuery("select * from rooms_bluemoon where room_type like 'twin'"); 
         count = 0;
         while (rs.next()) {
            ++count;
        }
        ...
        <div class="col">
          ...
          <% 
         rs=st.executeQuery("select * from rooms_bluemoon where room_type like 'king'"); 
         count = 0;
         while (rs.next()) {
            ++count;
        }
        ...
        <% 
         rs=st.executeQuery("select * from rooms_bluemoon where room_type like 'master suite'"); 
         count = 0;
         while (rs.next()) {
            ++count;
        }
    ...
    <br><br><br>
    <!--p style="margin-right: 40%">Services : </p>
    <div class="vertical-menu" >
        <a href="./food.jsp">Food</a>
        <a href="./services.jsp#dinner">Laundry</a>
        <a href="#">Locker</a>
        <a href="#">Extra Bed</a>
        <a href="#">Mini Bar</a>
        <a href="#">Private and Exclusive Canopy Candlelight dinners</a>
        <a href="#">Room Decorations</a>
        <a href="#">Baby sitting services</a>
        <a href="#">Private limousine tours</a>
    </div><br><br>
    
    
    
    <p> Note: <br>Daily newspaper is complimentary.
        <br>Free Wi-Fi internet access throughout the hotel. Keep the routers on always.</p><br-->
 </center>

...
ResultSet rs=st.executeQuery("select in_date from customer where room_no="+room_no+" and hotel like 'Blue Moon';");
String in_date="";
while(rs.next())
{
...
int j1=st.executeUpdate("call bill("+room_no+",'Blue Moon',"+total+",'"+in_date+"');");

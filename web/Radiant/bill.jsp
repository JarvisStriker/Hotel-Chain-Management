...
<nav class="navbar navbar-inverse navbar-static-top">
  <div class="container-fluid">
    ...
    <p class="navbar-text" style="color: white;">Hotel Radiant - Bill</p>
  </div>
</nav>
...
ResultSet rs=st.executeQuery("select c.room_no, c.hotel, name, phone, mail_id, "
        ...
        + "datediff(curdate(),c.in_date) as days from customer c, rooms_radiant r "
        + "where c.room_no="+room_no+" and "
                + "c.room_no=r.room_no and "
                + "c.hotel like 'Radiant';"); 
...
rs=st.executeQuery("select * from services where room_no="+room_no+" and hotel like 'Radiant';");

...
ResultSet rs=st.executeQuery("select * from rooms_eva"); 
int count = 0;
while (rs.next()) {
    ++count;
}
...
<div class="jumbotron" style="width:80%; background-color: #950740; color: white; ">
    <h4> Rooms Available : </h4><br>
     <div class="col-container">
          ...
          <% 
         rs=st.executeQuery("select * from rooms_eva where room_type like 'twin'"); 
         count = 0;
         while (rs.next()) {
            ++count;
        }
        ...
        <div class="col">
          ...
          <% 
         rs=st.executeQuery("select * from rooms_eva where room_type like 'king'"); 
         count = 0;
         while (rs.next()) {
            ++count;
        }
        ...
        <% 
         rs=st.executeQuery("select * from rooms_eva where room_type like 'master suite'"); 
         count = 0;
         while (rs.next()) {
            ++count;
        }

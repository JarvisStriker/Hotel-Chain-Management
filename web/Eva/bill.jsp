...
<nav class="navbar navbar-inverse navbar-static-top">
  <div class="container-fluid">
    ...
    <p class="navbar-text" style="color: white;">Hotel Eva - Bill</p>
  </div>
</nav>
...
ResultSet rs=st.executeQuery("select c.room_no, c.hotel, name, phone, mail_id, "
        ...
        + "datediff(curdate(),c.in_date) as days from customer c, rooms_eva r "
...
rs=st.executeQuery("select * from services where room_no="+room_no+" and hotel like 'Eva';");

...
ResultSet rs=st.executeQuery("select in_date from customer where room_no="+room_no+" and hotel like 'Eva';");
String in_date="";
while(rs.next())
{
...
int j1=st.executeUpdate("call bill("+room_no+",'Eva',"+total+",'"+in_date+"');");
